...
@registry.register_task(name="BehaviorEmptyTask-v0")
class BehaviorTask(NavigationTask):
    """
    ...
    def __init__(self, *args, sim, dataset=None, **kwargs) -> None:
        self.n_objs = len(dataset.episodes[0].objects)

        super().__init__(sim=sim, dataset=dataset, **kwargs)
        self.is_gripper_closed = False
        self._sim: BehaviorSim = sim
    ...
    def is_goal_state_satisfied(self) -> bool:
        # TODO: implement BDDL predicate checking
        return False
