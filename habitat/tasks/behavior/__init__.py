...
def _try_register_behavior_task():
    import habitat.tasks.behavior.actions
    import habitat.tasks.behavior.grip_actions
    import habitat.tasks.behavior.multi_task.composite_sensors
    import habitat.tasks.behavior.multi_task.composite_task
    import habitat.tasks.behavior.behavior_sensors
    import habitat.tasks.behavior.behavior_task
    import habitat.tasks.behavior.sub_tasks.articulated_object_sensors
    import habitat.tasks.behavior.sub_tasks.articulated_object_task
    import habitat.tasks.behavior.sub_tasks.nav_to_obj_sensors
    import habitat.tasks.behavior.sub_tasks.nav_to_obj_task
    import habitat.tasks.behavior.sub_tasks.pick_sensors
    import habitat.tasks.behavior.sub_tasks.pick_task
    import habitat.tasks.behavior.sub_tasks.place_sensors
    import habitat.tasks.behavior.sub_tasks.place_task
    import habitat.tasks.behavior.sub_tasks.reach_sensors
    import habitat.tasks.behavior.sub_tasks.reach_task
