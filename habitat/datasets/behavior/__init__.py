...
def _try_register_behaviordatasetv0():
    try:
        from habitat.datasets.behavior.behavior_dataset import (  # noqa: F401
            BehaviorDatasetV0,
        )

    except ImportError as e:
        behavior_import_error = e

        @registry.register_dataset(name="OrpNavDataset-v0")
        class BehaviorDatasetImportError(Dataset):
            def __init__(self, *args, **kwargs):
                raise behavior_import_error
